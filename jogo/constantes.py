...
TAMANHO_IMG_TELA_INICIAL = (TAMANHO_JANELA[1]*0.8,TAMANHO_JANELA[1])
IMG_TELA_INICIAL = pygame.transform.scale(pygame.image.load('jogo/assets/img/tela_inicial.png'),TAMANHO_IMG_TELA_INICIAL)
