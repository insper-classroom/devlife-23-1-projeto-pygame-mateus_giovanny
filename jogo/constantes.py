...
IMG_TELA_INICIAL = pygame.transform.scale(pygame.image.load('assets\img/tela_inicio_quadrada_2_tentativa.png'),TAMANHO_IMG_TELA_INICIAL)
IMG_TELA_INSTRUCOES = pygame.transform.scale(pygame.image.load('assets\img/tela_instruções_pronta.png'),TAMANHO_IMG_TELA_INICIAL)
IMG_TELA_PLACARES = pygame.transform.scale(pygame.image.load('assets/img/tela_pontuação.png'),TAMANHO_IMG_TELA_INICIAL)
IMG_TELA_GAME_OVER_1 = pygame.transform.scale(pygame.image.load('assets\img\TELA_GAME_OVER._1.png'),(700, 760))
IMG_TELA_GAME_OVER_PONTUACAO = pygame.transform.scale(pygame.image.load('assets\img\TELA_GAME_OVER_PONTUACAO.png'),(700, 760))
FONTE = 'fontes\BraahOne-Regular.ttf'

#som
COMENDO = pygame.mixer.Sound('assets\som\pac_comendo.ogg')
COMENDO_POWER = pygame.mixer.Sound('assets\som\power_pellet_obtain.wav')
COMENDO_FANTASMA = pygame.mixer.Sound('assets\som\ghost_eaten.wav')
...
PAC_MAN = [pygame.transform.scale(pygame.image.load('assets\img\PACs/baixo1.png'), TAMANHO_JOGADOR),pygame.transform.scale(pygame.image.load('assets\img\pac_man_E.png'), TAMANHO_JOGADOR),
pygame.transform.scale(pygame.image.load('assets\img\pac_man_C.png'), TAMANHO_JOGADOR),pygame.transform.scale(pygame.image.load('assets\img\pac_man_B.png'), TAMANHO_JOGADOR)]
VELOCIDADE = 5
